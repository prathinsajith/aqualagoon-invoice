...
export const AuditAction = {
  ...
  TRAINING_TYPE_CREATE: "TRAINING_TYPE_CREATE",
  TRAINING_TYPE_UPDATE: "TRAINING_TYPE_UPDATE",
  TRAINING_TYPE_DELETE: "TRAINING_TYPE_DELETE",
  ...
  FEE_PLAN_CREATE: "FEE_PLAN_CREATE",
  FEE_PLAN_UPDATE: "FEE_PLAN_UPDATE",
  FEE_PLAN_DELETE: "FEE_PLAN_DELETE",
